...
from src.models.custom_functions import topk_hidden_states_selector
    ...
    def forward(
        ...
        for idx, encoder_layer in enumerate(self.layers):
            ...
            if self.training and (dropout_probability < self.layerdrop):  # skip the layer
                ...
                if idx == 0:
                    layer_outputs = None
                hidden_states, topk_idx, _ = topk_hidden_states_selector(self, hidden_states, layer_outputs, idx, topk_idx, None)
        ...
        return BaseModelOutput(
            ...
            attentions=all_attentions, indicators=self.indicators,
        )
